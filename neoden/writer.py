...
class Writer:
    ...
    def create_file(self):
        with open(self.output, 'w', newline='') as outfile:
            ...
            writer.writerow(["", "", "", "", "", "", "", "", "", "", ""])
            writer.writerow(["Fiducial", "1-X", "0.00", "1-Y", "0.00", "OverallOffsetX", "0", "OverallOffsetY", "0", "", "", ""])
            writer.writerow(["", "", "", "", "", "", "", "", "", "", ""])
            ...
            for c in self.components:
                writer.writerow([c.ref, c.val, c.package, c.pos_x, c.pos_y, c.rot, c.head, c.feederNo, 100, 0, c.height, 1, 0])